...
<svelte:head>
	...
	{#if meta.video}
		<meta property="twitter:player:height" content={meta.video.height.toString()} />
		<meta property="twitter:player:width" content={meta.video.width.toString()} />
		<meta property="og:video:height" content={meta.video.height.toString()} />
		<meta property="og:video:width" content={meta.video.width.toString()} />
